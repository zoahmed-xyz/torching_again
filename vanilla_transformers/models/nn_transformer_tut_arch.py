...
# TransformerEncoder consists of multiple layers of TransformerEncoderLayer
# TransformerEncoderLayer is passed to the TransformerEncoder as a parameter
...
class TransformerModel(nn.Module):
    ...
    def forward(self, src: Tensor, src_mask: Tensor) -> Tensor:
        ...
        """
        # The mask is required so that the model does not attend to unseen words which it is tasked with outputting
        src = self.encoder(src.to(device)) * math.sqrt(self.d_model)
...
class PositionalEncoding(nn.Module):
    """ PositionalEncoding module injects some information about the relative or absolute position of the tokens
